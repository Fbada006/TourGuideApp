 ...
 */
public class SportsFragment extends Fragment implements FeatureAdapter.RecyclerViewClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        toolbar.setTitle(getString(R.string.category_sports));
        ...
        mFeatures.add(new Feature(getString(R.string.sports_mombasa), getString(R.string.sports_address), R.drawable.sports_image));
        mFeatures.add(new Feature(getString(R.string.sports_mombasa), getString(R.string.sports_address), R.drawable.sports_image));
        mFeatures.add(new Feature(getString(R.string.sports_mombasa), getString(R.string.sports_address), R.drawable.sports_image));
        mFeatures.add(new Feature(getString(R.string.sports_mombasa), getString(R.string.sports_address), R.drawable.sports_image));
        mFeatures.add(new Feature(getString(R.string.sports_mombasa), getString(R.string.sports_address), R.drawable.sports_image));
        ...
        FeatureAdapter mFeatureAdapter = new FeatureAdapter(mFeatures, R.color.category_sports, this);
